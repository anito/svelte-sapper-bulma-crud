...
const _posts = [
	{
		...
		html: `
			...
			<p>Sapper is a Next.js-style framework built around Svelte. It makes it embarrassingly easy to create extremely high performance web apps. Out of the box, you get:</p>
			<ul>
...

	{
		...
		message: 'In this example slugs are generated automatically from the title. Note the difference in urls of this article and the previous one although both share the same title.'
	}
];
